...
\begin{enumerate}[1.]
	...
	\item Исходные данные по работе: \uline{спецификации OAuth~2.0~\cite{RFC6749}, OpenID Connect~\cite{OpenIDConnect}, TLS~1.3~\cite{RFC8446}; научные публикации по~теме~\cite{Matias2023, Barabanov2021}.}
