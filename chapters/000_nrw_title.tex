...
\renewcommand{\SupervisorFull}{Резединова Евгения Юрьевна}
\renewcommand{\Supervisor}{Е.Ю.\,Резединова}
\renewcommand{\SupervisorDegree}{ст. преподаватель ВШ ПИ}
\renewcommand{\ConsultantExtraFull}{Сергеев Анатолий Васильевич}
\renewcommand{\ConsultantExtra}{А.В.\,Сергеев}
\renewcommand{\ConsultantExtraDegree}{к.т.н, доцент ВШ ПИ}
