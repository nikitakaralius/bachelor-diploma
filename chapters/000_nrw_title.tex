...
%%
%% Переопределения для НИР-титульника
\renewcommand{\SupervisorFull}{Сергеев Анатолий Васильевич}
\renewcommand{\Supervisor}{А.В.\,Сергеев}
\renewcommand{\SupervisorDegree}{к.т.н, доцент ВШ ПИ}
\renewcommand{\ConsultantExtraFull}{нет}
\renewcommand{\ConsultantExtra}{нет}
\renewcommand{\ConsultantExtraDegree}{}
\renewcommand{\PracticeStartDate}{04.05.2026}
\renewcommand{\PracticeEndDate}{18.05.2026}
\renewcommand{\Workplace}{ФГАОУ ВО «СПбПУ», ИКНК, ВШ ПИ, г.~Санкт-Петербург, ул.~Обручевых, д.~1, лит.~В}
%%
...
{\noindent \uline{\ConsultantExtraFull}}.%


{\noindent \bfseries
Руководитель практической подготовки от профильной организации:
}
{\noindent \expandafter \ulined \PracticeOrgSupervisorFull, \PracticeOrgSupervisorDegree.}
