...
\begin{document}
  ...
  % Титульник
  \input{chapters/000_nrw_title} % временно: НИР-титульник
  %\input{chapters/001_title} % основной титульник ВКР
  ...
  \input{chapters/009_chapter4}                % Глава 4
  % \ContinueChapterEnd
  ...
  \input{chapters/012_dictionary}    		 % Словарь терминов
  ...
  \input{chapters/014_appendix1}           % Приложение: CachedAuthJwtClient
