...
\newcommand{\ConsultantExtraVin}{А.В.\,Сергеева} % И. О. Фамилия дополнительного консультанта в винительном падеже (Кого? что? Руководителя ...)
\newcommand{\ConsultantExtraDegreeVin}{доцента ВШ ПИ, к.т.н} %  в винительном падеже (Кого? что? Руководителя ...)
%%% Второй консультант
...
%%
%%
\renewcommand{\thesisTitle}{Проектирование и интеграция компонентов аутентификации, авторизации и учёта в микросервисной архитектуре}
...
\newcommand{\thesisTitleEn}{Designing and integrating authentication, authorization, and accounting components for microservice architecture} %2020
...
\newcommand{\practiceTitle}{Проектирование и интеграция компонентов аутентификации, авторизации и учёта в микросервисной архитектуре}
